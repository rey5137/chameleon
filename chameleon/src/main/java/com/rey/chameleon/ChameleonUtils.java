 ...
 * For Chameleon.
 */
public final class ChameleonUtils {
    ...
    static void applyFontToTextView(final Context context, final TextView textView, final ChameleonConfig config) {
        applyFontToTextView(context, textView, config, false);
    }

    static void applyFontToTextView(final Context context, final TextView textView, final ChameleonConfig config, boolean deferred) {
     ...
     *                     defined font.
     */
    public static void applyFontToTextView(final Context context, final TextView textView, final ChameleonConfig config, final String textViewFont) {
        applyFontToTextView(context, textView, config, textViewFont, false);
    }

    static void applyFontToTextView(final Context context, final TextView textView, final ChameleonConfig config, final String textViewFont, boolean deferred) {
        if (context == null || textView == null || config == null) return;
