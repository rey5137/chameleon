 ...
 * For Chameleon.
 */
class ChameleonLayoutInflater extends LayoutInflater implements ChameleonActivityFactory {
    ...
    private final ChameleonFactory mChameleonFactory;
    // Reflection Hax
    private boolean mSetPrivateFactory = false;
    private Field mConstructorArgs = null;

    protected ChameleonLayoutInflater(Context context, int attributeId) {
        super(context);
        mAttributeId = attributeId;
        mChameleonFactory = new ChameleonFactory(attributeId);
        setUpLayoutFactories(false);
    }

    protected ChameleonLayoutInflater(LayoutInflater original, Context newContext, int attributeId, final boolean cloned) {
    ...
    public LayoutInflater cloneInContext(Context newContext) {
        return new ChameleonLayoutInflater(this, newContext, mAttributeId, true);
    }
    ...
    public void setFactory(Factory factory) {
        ...
        if (!(factory instanceof WrapperFactory)) {
            super.setFactory(new WrapperFactory(factory, this, mChameleonFactory));
        } else {
...
//            LayoutInflaterCompat.setFactory(this, new WrapperFactory2(factory2, mChameleonFactory));
            super.setFactory2(new WrapperFactory2(factory2, mChameleonFactory));
        } else {
    ...
    private void setPrivateFactoryInternal() {
        ...
        if (!ChameleonConfig.get().isReflection()) return;
        ...
        if (setPrivateFactoryMethod != null) {
            ReflectionUtils.invokeMethod(this,
                    ...
                    new PrivateWrapperFactory2((Factory2) getContext(), this, mChameleonFactory));
        }
        mSetPrivateFactory = true;
    }
    ...
    public View onActivityCreateView(View parent, View view, String name, Context context, AttributeSet attrs) {
        return mChameleonFactory.onViewCreated(createCustomViewInternal(parent, view, name, context, attrs), context, attrs);
    }
    ...
    protected View onCreateView(View parent, String name, AttributeSet attrs) throws ClassNotFoundException {
        return mChameleonFactory.onViewCreated(super.onCreateView(parent, name, attrs),
                getContext(), attrs);
    }
    ...
    protected View onCreateView(String name, AttributeSet attrs) throws ClassNotFoundException {
        ...
        return mChameleonFactory.onViewCreated(view, view.getContext(), attrs);
    }
    ...
    private View createCustomViewInternal(View parent, View view, String name, Context viewContext, AttributeSet attrs) {
        ...
        if (!ChameleonConfig.get().isCustomViewCreation()) return view;
    ...
    private static class WrapperFactory implements Factory {
        ...
        private final ChameleonLayoutInflater mInflater;
        private final ChameleonFactory mChameleonFactory;

        public WrapperFactory(Factory factory, ChameleonLayoutInflater inflater, ChameleonFactory chameleonFactory) {
            mFactory = factory;
            mInflater = inflater;
            mChameleonFactory = chameleonFactory;
        }

        @Override
        public View onCreateView(String name, Context context, AttributeSet attrs) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
                return mChameleonFactory.onViewCreated(
    ...
    private static class WrapperFactory2 implements Factory2 {
        ...
        protected final ChameleonFactory mChameleonFactory;

        public WrapperFactory2(Factory2 factory2, ChameleonFactory chameleonFactory) {
            mFactory2 = factory2;
            mChameleonFactory = chameleonFactory;
        }
    ...
    private static class PrivateWrapperFactory2 extends WrapperFactory2 {
        ...
        public PrivateWrapperFactory2(Factory2 factory2, ChameleonLayoutInflater inflater, ChameleonFactory chameleonFactory) {
            super(factory2, chameleonFactory);
            mInflater = inflater;
        }
